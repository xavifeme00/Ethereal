...
#define TuneNormal     (       856) // Flag to enable all Normals      (856)
#define TuneSafety     (       44) // Flag to enable all Safeties     ( 44)
#define TuneComplexity (       4) // Flag to enable all Complexities (  4)
